...
df2 = pd.read_csv('Capstone/JeevSauce/Phase2/includeNoCombine/merged_G_data_with_years.csv')

# Save the modified DataFrame to a new CSV file
df1.to_csv('Capstone/JeevSauce/Phase2/includeNoCombine/DraftedC_96-23.csv', index=False)
...
df2.to_csv('Capstone/JeevSauce/Phase2/includeNoCombine/Gdrafted.csv', index=False)
