...
df = pd.read_csv('Capstone/JeevSauce/Phase2/includeNoCombine/GDrafted.csv')

columns_to_exclude = ['player', 'player_id', 'player_game_count', 'attempts','Match','YOP']
...
df.to_csv('Capstone/JeevSauce/Phase2/includeNoCombine/normalized_G_data.csv', index=False)
