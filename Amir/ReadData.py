...
df = pd.read_csv('Amir/merged_RB_data.csv')
...
columns_to_normalize = [col for col in df.columns if col != ('player','player_id','player_game_count','attempts')]
...
df.to_csv('Amir/normalized_RB_data.csv', index=False)
